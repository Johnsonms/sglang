...
def _get_k_triton_kernel(
    ...
    src_base_offset = page_index * buf_numel_per_page + token_offset_in_page * index_head_dim
...
def _get_s_triton_kernel(
    ...
    src_base_offset = page_index * buf_numel_per_page + s_offset_in_page + token_offset_in_page * 4
...
def _get_k_and_s_triton_kernel(
    ...
    k_src_base_offset = page_index * buf_numel_per_page + token_offset_in_page * index_head_dim
    ...
    s_src_base_offset = page_index * buf_numel_per_page + s_offset_in_page + token_offset_in_page * 4
