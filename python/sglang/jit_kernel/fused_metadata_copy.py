...
def _make_empty_tensor_if_none(tensor: Optional[torch.Tensor]) -> torch.Tensor:
    """Convert None to an empty tensor for JIT calls."""
    if tensor is None:
...
def fused_metadata_copy_cuda(
    ...
    # Convert None tensors to empty tensors for JIT call
    real_page_table_src_arg = _make_empty_tensor_if_none(real_page_table_src)
    flashmla_num_splits_src_arg = _make_empty_tensor_if_none(flashmla_num_splits_src)
    flashmla_metadata_src_arg = _make_empty_tensor_if_none(flashmla_metadata_src)
    real_page_table_dst_arg = _make_empty_tensor_if_none(real_page_table_dst)
...
def fused_metadata_copy_multi_cuda(
    ...
    real_page_table_dst0_arg = _make_empty_tensor_if_none(real_page_table_dst0)
    flashmla_num_splits_dst0_arg = _make_empty_tensor_if_none(flashmla_num_splits_dst0)
    flashmla_metadata_dst0_arg = _make_empty_tensor_if_none(flashmla_metadata_dst0)

    real_page_table_dst1_arg = _make_empty_tensor_if_none(real_page_table_dst1)
    flashmla_num_splits_dst1_arg = _make_empty_tensor_if_none(flashmla_num_splits_dst1)
    flashmla_metadata_dst1_arg = _make_empty_tensor_if_none(flashmla_metadata_dst1)
