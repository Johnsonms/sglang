...
#SBATCH --job-name=nccl_4n_med
#SBATCH --time=00:10:00
#SBATCH --output=nccl_4node_nvls_medium_%j.out

# ============================================
# 4-Node NVLS - Medium to Large Messages (512M-2G)
# ============================================
...
echo "============================================"
echo "4-Node NVLS - Medium Messages (512M-2G)"
echo "Job started: $(date)"
echo "Nodes: $SLURM_NODELIST"
echo "============================================"

# Test medium to large messages: 512M to 2G
srun --cpu-bind=none ./build/all_reduce_perf -b 512M -e 2G -f 2 -g 8
