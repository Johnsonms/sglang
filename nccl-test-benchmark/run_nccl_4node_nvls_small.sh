...
#SBATCH --job-name=nccl_4n_small
#SBATCH --time=00:10:00
#SBATCH --output=nccl_4node_nvls_small_%j.out

# ============================================
# 4-Node NVLS - Small to Medium Messages (64M-512M)
# ============================================
...
echo "============================================"
echo "4-Node NVLS - Small Messages (64M-512M)"
echo "Job started: $(date)"
echo "Nodes: $SLURM_NODELIST"
echo "============================================"

# Test small to medium messages: 64M to 512M
srun --cpu-bind=none ./build/all_reduce_perf -b 64M -e 512M -f 2 -g 8
