...
#SBATCH --job-name=jax_2node           # Job name
#SBATCH --time=00:20:00                # 20 minutes
#SBATCH --output=jax_benchmark_2node_%j.out
#SBATCH --error=jax_benchmark_2node_%j.out

# ============================================
# JAX All-Reduce Benchmark - 2 Nodes (16 GPUs)
# ============================================

echo "============================================"
echo "JAX 2-Node Benchmark Job Started"
...
echo ""
echo "============================================"
echo "Starting JAX 2-Node Benchmark..."
echo "============================================"
echo ""
