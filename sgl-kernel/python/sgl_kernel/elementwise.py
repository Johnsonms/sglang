...
# ============================================================================
# Compiled versions (using sgl_kernel torch ops)
# ============================================================================


def rmsnorm_compiled(
    input: torch.Tensor,
    weight: torch.Tensor,
    eps: float = 1e-6,
    ...
    r"""Compiled version: Root mean square normalization.
...
def rmsnorm(
    ...
    r"""JIT version: Root mean square normalization.
...
def fused_add_rmsnorm_compiled(
    input: torch.Tensor,
    ...
    r"""Compiled version: Fused add root mean square normalization.
...
def fused_add_rmsnorm(
    ...
    r"""JIT version: Fused add root mean square normalization.
...
def gemma_rmsnorm_compiled(
    ...
    r"""Compiled version: Gemma-style root mean square normalization.
...
def gemma_rmsnorm(
    ...
    r"""JIT version: Gemma-style root mean square normalization.
...
def gemma_fused_add_rmsnorm_compiled(
    input: torch.Tensor,
    residual: torch.Tensor,
    weight: torch.Tensor,
    eps: float = 1e-6,
    ...
    r"""Compiled version: Gemma-style fused add root mean square normalization.
...
def gemma_fused_add_rmsnorm(
    ...
    r"""JIT version: Gemma-style fused add root mean square normalization.
